...
| ------------- | ------------------- | --------------------------- | ---------------------------------------------------------------------- |
| `detected`    | `DetectedBarcode[]` | _required_                  | Detected barcodes whose `cornerPoints` are drawn as polygons.          |
| `viewBox`     | `string`            | _required_                  | SVG `viewBox` matching the source's intrinsic size.                    |
| `fill`        | `string`            | `'rgba(0, 200, 120, 0.15)'` | Polygon fill.                                                          |
| `stroke`      | `string`            | `'rgb(0, 200, 120)'`        | Polygon stroke.                                                        |
